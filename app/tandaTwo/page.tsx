...
const pages = () => {
  ...
  // const socket = io.connect("https://paha345-pahagameexpressserver-adac.twc1.net");
  ...
  return (
    <>
      {/* <button onClick={startWSServer}>Start WS Server</button> */}
      <div>
