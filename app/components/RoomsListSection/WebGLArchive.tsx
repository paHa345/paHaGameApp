...
//     gltfLoader.load("/models/Fox/glTF/Fox.gltf", (gltf: GLTF) => {
//       // const children = [...gltf.scene.children];
//       // for (const child of children) {
//       //   scene.add(child);
//       // }
//       mixer = new THREE.AnimationMixer(gltf.scene);
//       const runAnimation = mixer.clipAction(gltf.animations[2]);
//       runAnimation.play();
...
//     //     vUv.y * 0.5 + 0.25
//     // );
//     // float strength = 0.015 / distance(lengthUv, vec2(0.5, 0.5));
...
//     //     vUv.y * 0.5 + 0.25
//     // );
//     // float lightX = 0.015 / distance(lengthUvX, vec2(0.5, 0.5));

//     // vec2 lengthUvY = vec2(
//     //     vUv.y * 0.1 + 0.45,
//     //     vUv.x * 0.5 + 0.25
//     // );
//     // float lightY = 0.015 / distance(lengthUvY, vec2(0.5, 0.5));
...
//     // vec2 lengthUvX = vec2(rotatedUv.x * 0.1 + 0.45,rotatedUv.y * 0.5 + 0.25);
//     // float lightX = 0.015 / distance(lengthUvX, vec2(0.5));

//     // vec2 lengthUvY = vec2(rotatedUv.y * 0.1 + 0.45,rotatedUv.x * 0.5 + 0.25);
//     // float lightY = 0.015 / distance(lengthUvY, vec2(0.5));
...
// vertex and fragment shaders from sheders/water
...
// vertex and fragment shaders from /shaders/galaxy
...
//       const customUniformes = {
//         uTime: { value: 0 },
//       };

//       material.onBeforeCompile = (shader) => {
//         shader.uniforms.uTime = customUniformes.uTime;
...
//         customUniformes.uTime.value = elapsedTime;
...
// vertex and fragment shaders from sheders/cofeeCmoke
...
// vertex and fragment shaders /shaders/holographic
...
// vertex, fragment shaders /shaders/firework
...
// vertex and fragment shader in /shaders/shading
...
// vertex and fragment /shaders/earth
//                     /shaders/atmosphere
...
/**
 * 39 Particles cursor animatios shaders
 */

// vertex and fragment /shaders/particles
...
/**
 * 40 Particles morph shaders
 */

// vertex and fragment /shaders/morphParticles
...
/**
 * 41 GPGPU Flow field particles shader
 */

// vertex and fragment shader from /shaders/40_gpgpuParticles
// particles shaders from /shaders/gpgpu/
...
//         try {
//           const gltf = await gltfLoader.loadAsync("./shipModel.glb");
...
//       const baseGeometry = {
//         instance: modelRef.current.scene.children[0].geometry,
//         count: 0,
//       };
...
//         if (!baseParticlesTexture.image.data) return;
...
//         new THREE.MeshBasicMaterial({
//           map: gpgpu.computation.getAlternateRenderTarget(gpgpu.particlesVariable).texture,
//         }),
//       );
...
//               new THREE.Vector2(sizes.width * sizes.pixelRatio, sizes.height * sizes.pixelRatio),
//             ),
//             uParticlesTexture: new THREE.Uniform(1),
//           },
//         }),
//       };
...
//         if (!gpgpu.particlesVariable) return;
...
// vertex and fragment shaders from /shaders/wobble
...
/**
 * 43 Sliced model shader
 */

// vertex and fragment /shaders/sliced
...
/**
 * 44 Procedural terrain shader
 */

// vertex and fragment shader /shader/terrain
...
//       // Unreal bloom pass
//       const unrealBloomPass = new UnrealBloomPass(sizes.resolution, 0.3, 1, 0.6);
...
//         const smaPass = new SMAAPass();
//         effectComposer.addPass(smaPass);
//       }
