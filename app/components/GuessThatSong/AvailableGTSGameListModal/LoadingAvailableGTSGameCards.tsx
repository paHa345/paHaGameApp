...
const LoadingAvailableGTSGameCards = () => {
        ...
        <div className=" flex flex-col">
          <div className=" flex flex-col gap-2">
            <div className=" flex flex-col justify-center items-center">
              ...
              <div>
                <FontAwesomeIcon
                  className={` ${fetchGTSGamesStatus === GTSGameFetchStatus.Loading ? "animate-spin " : ""}  fa-fw fa-3x`}
                  icon={faSpinner}
                />
              </div>
...
export default LoadingAvailableGTSGameCards;
