  ...
  return (
    <ReduxProvider>
      ...
      >
        ...
        <nav className=" pl-10 sm:pl-0 border-t-2 border-solid border-lime-100 sm:border-0  rounded-t-3xl sm:rounded-none py-3 sm:py-1 pt-24 ml-0 bg-gradient-to-tr from-headerFooterMainColor to-lime-50 w-full sticky bottom-0 sm:relative flex flex-row items-center justify-start sm:justify-center mx-6 gap-5">
